...
function setup(){
    ...
    t1 = new Target (1000,470);
    t2 = new Target (1030,470);
    t3 = new Target (1060,470);
    t4 = new Target (970,470);
    t5 = new Target (940,470);
    t6 = new Target (1030,440);
    t7 = new Target (1000,440);
    t8 = new Target (970,440);
    t9 = new Target (1000,410);
